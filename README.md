...
_<b>NOTE:</b> The following below uses materials created in the previous demonstration, ["Creating an Azure Account ➔ Establishing a Virtual Machine"](https://github.com/johnyangtech/azure-start)._
...
<h2><p align=center>Next Demonstration:<br><a href="https://github.com/johnyangtech/azure-network-protocols">Network Security Groups (NSGs) and Inspecting Network Protocols</a></p></h2>
